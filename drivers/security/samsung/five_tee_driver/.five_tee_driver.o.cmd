cmd_drivers/security/samsung/five_tee_driver/five_tee_driver.o := ./bin/clang -Wp,-MD,drivers/security/samsung/five_tee_driver/.five_tee_driver.o.d -nostdinc -isystem /usr/lib/gcc/x86_64-linux-gnu/13/include -I./arch/arm64/include -I./arch/arm64/include/generated  -I./include -I./arch/arm64/include/uapi -I./arch/arm64/include/generated/uapi -I./include/uapi -I./include/generated/uapi -include ./include/linux/kconfig.h -include ./include/linux/compiler_types.h -D__KERNEL__ -mlittle-endian -Qunused-arguments -Wall -Wundef -Wno-trigraphs -fno-strict-aliasing -fno-common -fshort-wchar -Wno-format-security -std=gnu89 -DANDROID_VERSION=130000 -DANDROID_MAJOR_VERSION=t -Wno-sizeof-pointer-div --target=aarch64-linux-gnu --prefix=/home/owo/toolchains/arm64/bin/ --gcc-toolchain=/home/owo/toolchains/arm64 -no-integrated-as -Werror=unknown-warning-option -fno-PIE -mgeneral-regs-only -DCONFIG_AS_LSE=1 -fno-asynchronous-unwind-tables -fno-delete-null-pointer-checks -Wno-address-of-packed-member -O3 -Wframe-larger-than=4096 -fstack-protector-strong -Wno-format-invalid-specifier -Wno-gnu -Wno-tautological-compare -mno-global-merge -Wno-unused-const-variable -fno-omit-frame-pointer -fno-optimize-sibling-calls -g -Wdeclaration-after-statement -Wno-pointer-sign -fno-strict-overflow -fno-merge-all-constants -fno-stack-check -Werror=implicit-int -Werror=date-time -Wno-initializer-overrides -Wno-unused-value -Wno-format -Wno-sign-compare -Wno-format-zero-length -Wno-uninitialized -Wformat -I./drivers/security/samsung/five_tee_driver/multibuild/source/gp-api/protocol -I./drivers/security/samsung/five_tee_driver/multibuild/source/gp-api/client -I./drivers/misc/tzdev/include/tzdev    -DKBUILD_BASENAME='"five_tee_driver"' -DKBUILD_MODNAME='"fiveteedriver"' -c -o drivers/security/samsung/five_tee_driver/.tmp_five_tee_driver.o drivers/security/samsung/five_tee_driver/five_tee_driver.c

source_drivers/security/samsung/five_tee_driver/five_tee_driver.o := drivers/security/samsung/five_tee_driver/five_tee_driver.c

deps_drivers/security/samsung/five_tee_driver/five_tee_driver.o := \
    $(wildcard include/config/tee/driver/debug.h) \
    $(wildcard include/config/five/early/load/trusted/app.h) \
  ...
  drivers/security/samsung/five_tee_driver/five_ta_uuid.h \
    $(wildcard include/config/five/use/tzdev.h) \
    $(wildcard include/config/five/use/qsee.h) \
    $(wildcard include/config/arch/lahaina.h) \
    $(wildcard include/config/arch/msm8917.h) \
    $(wildcard include/config/five/use/trustonic.h) \
    $(wildcard include/config/five/use/emulator.h) \
  drivers/security/samsung/five_tee_driver/five_tee_interface.h \
...
drivers/security/samsung/five_tee_driver/five_tee_driver.o: $(deps_drivers/security/samsung/five_tee_driver/five_tee_driver.o)
